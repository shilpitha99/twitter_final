...
while True:
    user = api.get_user('Shilpitha11')
    api.update_profile(name=f'shilpitha|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : shilpitha|{follower_count(user)} Followers')
